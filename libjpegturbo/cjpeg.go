package libjpegturbo

/*
 #cgo CFLAGS: -I/opt/libjpeg-turbo/include/
 #cgo LDFLAGS: -L/opt/libjpeg-turbo/lib64 -lturbojpeg -ljpeg -Wl,-rpath=/opt/libjpeg-turbo/lib64/
 #include <stdio.h>
#include <jpeglib.h>
#include <stdlib.h>
#include <setjmp.h>
...
//calls libjpeg-turbo underneath
func Compress(imageBytes []byte, params mozjpego.Parameters) ([]byte, error) {
	//check image type
